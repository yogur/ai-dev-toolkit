...
- Default stack unless the repo CLAUDE.md says otherwise: `uv`, `ruff`, `pytest`.
...
## Repo-Level CLAUDE.md Maintenance

When maintaining a repo-level CLAUDE.md, use these sections in order:
...
- Never duplicate content from this root CLAUDE.md; repo files extend or override, not repeat.
